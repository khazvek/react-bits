  ...
  const tweets = [
    {
      ...
      text: 'Saw a lot of UI components & libraries but kauryui.dev has it all',
    ...
    },
    {
      ...
      text: 'Just discovered http://kauryui.dev — a sleek, minimal, and super dev-friendly React component library. Clean UI, easy to use, and perfect for modern projects.',
      handle: '@syskey_dmg',
    ...
    },
    {
      ...
      text: 'Really impressed by https://kauryui.dev. Check it out. The Splash Cursor effect is amazing.',
    ...
    },
    {
      ...
      text: 'KauryUI: A stellar collection of React components to make your landing pages shine ✨',
      handle: '@gregberge_',
    ...
    },
    {
      ...
      text: 'Have you heard of KauryUI? David Haz has lovingly put together a collection of animated and fully customizable React components.',
      handle: '@DIYDevs',
    ...
    },
    {
      ...
      text: 'KauryUI has got to be the most artistic ui component lib I have seen in a while 🤌',
    ...
    },
    {
      ...
      text: 'This React library is absolutely amazing!!! KauryUI is packed with animated components that make building creative and interactive websites so much easier.',
      handle: '@Traccey001',
      ...
      <div className="testimonials-container">
        <div className="testimonials-header">
          ...
          <p className="testimonials-subtitle">
            See what developers are saying about KauryUI
          </p>
        </div>
